...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    _LOGGER.info("processor/mqtt_code.py - async_setup_platform")
    ...
    _LOGGER.info("async_setup_platform Platform Config: " + str(config))
    _LOGGER.info("async_setup_platform Platform discovery_info: " + str(discovery_info))
    config_items = discovery_info[0]['entities']
    _LOGGER.info("async_setup_platform Platform config_items: " + str(len(config_items)))
...
# ):
#     _LOGGER.info("setup_platform for processor.py")
#     from homeassistant.components import mqtt
#     entities = []
